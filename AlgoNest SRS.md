AlgoNest — Software Requirements Specification (SRS)
...
1.1 Purpose
This document specifies the software requirements for AlgoNest, a minimal,
...
1.2 System Overview
AlgoNest is a web-based practice platform where users write code in the browser and submit
...
- Developers who use AlgoNest to practice DSA problems
